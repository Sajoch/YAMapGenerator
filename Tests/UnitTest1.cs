...
namespace Tests {
    public class TileConnectionContainerTests {
        ...
        [TestCase("1,2,2,2,3;4,5,5,5,6;7,8,8,8,9")]
        [TestCase("1,2,2,2,2,3;4,5,5,5,5,6;7,8,8,8,8,9")]
        ...
        public void CheckValidTiles(string input) {
            ...
            var generator = new MapGenerator(connections, allTiles.ToList(), basicMap.Width, basicMap.Height, new GetFirstSelection<TileScheme>());
        ...
        [Ignore("testhost.exe' has exited with code -1073741819 (0xc0000005) 'Access violation'.")]
        [TestCase("1,2,3;4,5,6;7,8,9")]
        [TestCase("1,2,2,3;4,5,5,6;7,8,8,9")]
        [TestCase("1,2,2,2,3;4,5,5,5,6;7,8,8,8,9")]
        [TestCase("1,2,2,2,2,3;4,5,5,5,5,6;7,8,8,8,8,9")]
        [TestCase("1,2,2,2,2,3;4,5,5,5,5,6;4,5,5,5,5,6;4,5,5,5,5,6;7,8,8,8,8,9")]
        public void CheckValidTilesRandom(string input) {
            var reader = new SimpleMapReader(input);
            var allTiles = reader.GetTileSchemes();
            var connections = new TileConnectionContainer();
            var basicMap = reader.CreateMap();
